...
// changes we need in admin panel and doctors panel
...
// API to get doctors appointments for doctor dashboard
...
// API to get dashboard data from doctor-dashboard
const doctorDashboard=async(req,res)=>{
    try {
        
        const {docId}= req.body;
        // get appointments of particulat doctor
        const appointments= await appointmentModel.find({docId})
...
// API to update doctor profile data fromdoctor dashboard
